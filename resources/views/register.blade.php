    ...
    <div class="bg-[#FFDCDC] p-8 rounded-xl w-full max-w-md border border-black shadow-[3px_3px_16px_0px_rgba(0,0,0,1)]">
        ...
        <form action="{{ route('register.post') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" class="w-full bg-white rounded p-2.5 outline-none focus:ring-2 focus:ring-green-500 transition" required>
            </div>
            <div>
                <label class="block text-sm mb-1 text-gray-600">Email</label>
                <input type="email" name="email" class="w-full bg-white rounded p-2.5 outline-none focus:ring-2 focus:ring-green-500 transition" required>
